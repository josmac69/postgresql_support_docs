# AI Tools & PostgreSQL AI Resources

This directory contains resources, cheat sheets, and references mapping the intersection of Artificial Intelligence and PostgreSQL databases.

## Directory Contents

*   **[8 Hidden Claude Features (PDF)](file:///home/josef/github.com/josmac69/postgresql_support_docs/AI_tools/8_Hidden_Claude_Features_97perc_of_People_Dont_Know___LinkedIn.pdf)**: A guide detailing advanced prompting capabilities, context length optimizations, and system features of Anthropic's Claude.
*   **PostgreSQL AI Projects and Resources**: A curated list of projects, extensions, and demos showcasing how to use PostgreSQL in the AI landscape (detailed below).

---

# Curated List of PostgreSQL® AI Projects and Resources
...
* 📽️ [Creating a Board Game Chatbot with Postgres, AI, and RAG](https://www.youtube.com/watch?v=EXk08pYVxfE) by [Matt Cornillon](https://www.linkedin.com/in/matt-cornillon/) at [pgconf.eu 2023](https://2024.pgconf.eu/)
